...
def get_mixed_type_key(obj):
    ...
    """
    if isinstance(obj, IPv4Interface) or isinstance(obj, IPv6Interface):
        return (obj._version, obj._ip, 2, obj.network.network_address, obj.netmask)
    if isinstance(obj, _BaseNetwork):
        return (obj._version, int(obj.network_address), 1, int(obj.netmask))
    elif isinstance(obj, _BaseAddress):
        return (obj._version, obj._ip, 0)
...
class _BaseNetwork(_IPAddressBase):
    ...
    def is_private(self):
        ...
        """
        if self._version == 4 and self.network_address == self._address_class(0) and self._prefixlen == 0:
            return True
...
class _BaseV4:
    ...
    def _ip_int_from_string(cls, ip_str):
        ...
        try:
            return int.from_bytes(bytes(map(cls._parse_octet, octets)), 'big')
