...
fn unicode_name_to_char(name: &str) -> Option<char> {
    ...
    match name_upper.as_str() {
        ...
        "OGHAM SPACE MARK" => Some('\u{1680}'),
        // Latin small letters with diacritics (commonly tested)
        "LATIN SMALL LETTER A WITH DIAERESIS" => Some('\u{00E4}'),
        "LATIN SMALL LETTER O WITH DIAERESIS" => Some('\u{00F6}'),
        "LATIN SMALL LETTER A WITH ACUTE" => Some('\u{00E1}'),
        "LATIN SMALL LETTER E WITH GRAVE" => Some('\u{00E8}'),
        "LATIN SMALL LETTER I WITH ACUTE" => Some('\u{00ED}'),
        "LATIN SMALL LETTER O WITH ACUTE" => Some('\u{00F3}'),
        "LATIN SMALL LETTER U WITH ACUTE" => Some('\u{00FA}'),
        "LATIN SMALL LETTER C WITH CEDILLA" => Some('\u{00E7}'),
        "LATIN SMALL LETTER A WITH CIRCUMFLEX" => Some('\u{00E2}'),
        "LATIN SMALL LETTER E WITH CIRCUMFLEX" => Some('\u{00EA}'),
        "LATIN SMALL LETTER I WITH CIRCUMFLEX" => Some('\u{00EE}'),
        "LATIN SMALL LETTER O WITH CIRCUMFLEX" => Some('\u{00F4}'),
        "LATIN SMALL LETTER U WITH CIRCUMFLEX" => Some('\u{00FB}'),
        "LATIN SMALL LETTER I WITH DIAERESIS" => Some('\u{00EF}'),
        "LATIN SMALL LETTER Y WITH DIAERESIS" => Some('\u{00FF}'),
        "LATIN CAPITAL LETTER A WITH DIAERESIS" => Some('\u{00C4}'),
        "LATIN CAPITAL LETTER O WITH DIAERESIS" => Some('\u{00D6}'),
        "LATIN CAPITAL LETTER U WITH DIAERESIS" => Some('\u{00DC}'),
        "LATIN SMALL LETTER A WITH TILDE" => Some('\u{00E3}'),
        "LATIN SMALL LETTER O WITH TILDE" => Some('\u{00F5}'),
        // Superscripts and subscripts
        "SUPERSCRIPT TWO" => Some('\u{00B2}'),
        "SUPERSCRIPT THREE" => Some('\u{00B3}'),
        "SUPERSCRIPT ONE" => Some('\u{00B9}'),
        ...
        "INVERTED QUESTION MARK" => Some('\u{00BF}'),
        "NOT SIGN" => Some('\u{00AC}'),
