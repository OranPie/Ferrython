...
use ferrython_core::object::{make_builtin, PyCell, PyObject, PyObjectMethods, PyObjectRef};
...
pub fn make_queue_class() -> PyObjectRef {
    make_builtin(|args: &[PyObjectRef]| {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.put", move |args| {
                if args.is_empty() {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.get", move |_| {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.put_nowait", move |args| {
                if args.is_empty() {
                    return Err(PyException::type_error(
                        "Queue.put_nowait() requires an argument",
                    ));
                }
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.get_nowait", move |_| {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.qsize", move |_| {
                Ok(PyObject::int(items_qs.read().len() as i64))
            }),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.empty", move |_| {
                Ok(PyObject::bool_val(items_em.read().is_empty()))
            }),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Queue.full", move |_| {
                if ms <= 0 {
        ...
        attrs.insert(
            ...
            make_builtin(|_| Ok(PyObject::builtin_awaitable(PyObject::none()))),
        );
...
pub fn make_event_class() -> PyObjectRef {
    make_builtin(|_args: &[PyObjectRef]| {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Event.set", move |_| {
                *f.write() = true;
                Ok(PyObject::none())
            }),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Event.clear", move |_| {
                *f.write() = false;
                Ok(PyObject::none())
            }),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Event.is_set", move |_| Ok(PyObject::bool_val(*f.read()))),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Event.wait", move |_| {
                if *f.read() {
...
pub fn make_lock_class() -> PyObjectRef {
    make_builtin(|_args: &[PyObjectRef]| {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Lock.acquire", move |_| {
                *l.write() = true;
                Ok(PyObject::builtin_awaitable(PyObject::bool_val(true)))
            }),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Lock.release", move |_| {
                let mut w = l.write();
                if !*w {
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Lock.locked", move |_| Ok(PyObject::bool_val(*l.read()))),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Lock.__aenter__", move |_| {
                *l.write() = true;
                Ok(PyObject::builtin_awaitable(PyObject::none()))
            }),
        );
        ...
        attrs.insert(
            ...
            PyObject::native_closure("Lock.__aexit__", move |_| {
                *l.write() = false;
                Ok(PyObject::builtin_awaitable(PyObject::none()))
            }),
        );
...
pub fn make_semaphore_class() -> PyObjectRef {
    make_builtin(|args: &[PyObjectRef]| {
        ...
        attrs.insert(
            CompactString::from("acquire"),
            PyObject::native_closure("Semaphore.acquire", move |_| {
                let mut val = v.write();
                if *val > 0 {
                    *val -= 1;
                    Ok(PyObject::builtin_awaitable(PyObject::bool_val(true)))
        ...
        attrs.insert(
            CompactString::from("release"),
            PyObject::native_closure("Semaphore.release", move |_| {
                *v.write() += 1;
                Ok(PyObject::none())
            }),
        );
        ...
        attrs.insert(
            CompactString::from("__aenter__"),
            PyObject::native_closure("Semaphore.__aenter__", move |_| {
                let mut val = v.write();
                if *val > 0 {
                    *val -= 1;
                }
        ...
        attrs.insert(
            CompactString::from("__aexit__"),
            PyObject::native_closure("Semaphore.__aexit__", move |_| {
                *v.write() += 1;
                Ok(PyObject::builtin_awaitable(PyObject::none()))
            }),
        );
...
pub fn make_bounded_semaphore_class() -> PyObjectRef {
    make_builtin(|args: &[PyObjectRef]| {
        ...
        attrs.insert(
            CompactString::from("acquire"),
            PyObject::native_closure("BoundedSemaphore.acquire", move |_| {
                let mut val = v.write();
                if *val > 0 {
                    *val -= 1;
                    Ok(PyObject::builtin_awaitable(PyObject::bool_val(true)))
        ...
        attrs.insert(
            CompactString::from("release"),
            PyObject::native_closure("BoundedSemaphore.release", move |_| {
                let mut val = v.write();
                if *val >= bound {
...
pub fn make_condition_class() -> PyObjectRef {
    make_builtin(|_args: &[PyObjectRef]| {
        ...
        attrs.insert(
            CompactString::from("acquire"),
            PyObject::native_closure("Condition.acquire", move |_| {
                *l.write() = true;
                Ok(PyObject::builtin_awaitable(PyObject::bool_val(true)))
            }),
        );
        ...
        attrs.insert(
            CompactString::from("release"),
            PyObject::native_closure("Condition.release", move |_| {
                *l.write() = false;
                Ok(PyObject::none())
            }),
        );
        ...
        attrs.insert(
            CompactString::from("wait"),
            make_builtin(|_| Ok(PyObject::builtin_awaitable(PyObject::bool_val(true)))),
        );
        attrs.insert(
        ...
        attrs.insert(
            CompactString::from("locked"),
            PyObject::native_closure("Condition.locked", move |_| {
                Ok(PyObject::bool_val(*l.read()))
            }),
        );
