...
fn install_date_instance_attrs(w: &mut IndexMap<CompactString, PyObjectRef, impl std::hash::BuildHasher>, year: i64, month: i64, day: i64) {
    w.insert(CompactString::from("__datetime__"), PyObject::bool_val(true));
    w.insert(CompactString::from("__date_only__"), PyObject::bool_val(true));
    w.insert(CompactString::from("year"), PyObject::int(year));
    w.insert(CompactString::from("month"), PyObject::int(month));
...
pub fn create_strptime_module() -> PyObjectRef {
    make_module("_strptime", vec![
        ("_strptime_datetime", make_builtin(|args| {
        ...
        ("_strptime_time", make_builtin(|_args| {
            Ok(PyObject::tuple(vec![
                PyObject::int(0), PyObject::int(0), PyObject::int(0),
                PyObject::int(0), PyObject::int(0), PyObject::int(0),
                PyObject::int(0), PyObject::int(0), PyObject::int(-1),
