...
pub fn create_builtins_module() -> PyObjectRef {
    make_module("builtins", vec![
        ...
        ("EnvironmentError", PyObject::exception_type(ferrython_core::error::ExceptionKind::OSError)),
        ...
        // All remaining exception types
        ("BaseException", PyObject::exception_type(ferrython_core::error::ExceptionKind::BaseException)),
        ("ArithmeticError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ArithmeticError)),
        ("BaseExceptionGroup", PyObject::exception_type(ferrython_core::error::ExceptionKind::BaseExceptionGroup)),
        ("BlockingIOError", PyObject::exception_type(ferrython_core::error::ExceptionKind::BlockingIOError)),
        ("BrokenPipeError", PyObject::exception_type(ferrython_core::error::ExceptionKind::BrokenPipeError)),
        ("BufferError", PyObject::exception_type(ferrython_core::error::ExceptionKind::BufferError)),
        ("BytesWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::BytesWarning)),
        ("ChildProcessError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ChildProcessError)),
        ("ConnectionAbortedError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ConnectionAbortedError)),
        ("ConnectionError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ConnectionError)),
        ("ConnectionRefusedError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ConnectionRefusedError)),
        ("ConnectionResetError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ConnectionResetError)),
        ("DeprecationWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::DeprecationWarning)),
        ("EOFError", PyObject::exception_type(ferrython_core::error::ExceptionKind::EOFError)),
        ("EncodingWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::EncodingWarning)),
        ("ExceptionGroup", PyObject::exception_type(ferrython_core::error::ExceptionKind::ExceptionGroup)),
        ("FileExistsError", PyObject::exception_type(ferrython_core::error::ExceptionKind::FileExistsError)),
        ("FloatingPointError", PyObject::exception_type(ferrython_core::error::ExceptionKind::FloatingPointError)),
        ("FutureWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::FutureWarning)),
        ("GeneratorExit", PyObject::exception_type(ferrython_core::error::ExceptionKind::GeneratorExit)),
        ("ImportWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::ImportWarning)),
        ("IndentationError", PyObject::exception_type(ferrython_core::error::ExceptionKind::IndentationError)),
        ("InterruptedError", PyObject::exception_type(ferrython_core::error::ExceptionKind::InterruptedError)),
        ("IsADirectoryError", PyObject::exception_type(ferrython_core::error::ExceptionKind::IsADirectoryError)),
        ("KeyboardInterrupt", PyObject::exception_type(ferrython_core::error::ExceptionKind::KeyboardInterrupt)),
        ("LookupError", PyObject::exception_type(ferrython_core::error::ExceptionKind::LookupError)),
        ("MemoryError", PyObject::exception_type(ferrython_core::error::ExceptionKind::MemoryError)),
        ("ModuleNotFoundError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ModuleNotFoundError)),
        ("NotADirectoryError", PyObject::exception_type(ferrython_core::error::ExceptionKind::NotADirectoryError)),
        ("PendingDeprecationWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::PendingDeprecationWarning)),
        ("PermissionError", PyObject::exception_type(ferrython_core::error::ExceptionKind::PermissionError)),
        ("ProcessLookupError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ProcessLookupError)),
        ("RecursionError", PyObject::exception_type(ferrython_core::error::ExceptionKind::RecursionError)),
        ("ReferenceError", PyObject::exception_type(ferrython_core::error::ExceptionKind::ReferenceError)),
        ("ResourceWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::ResourceWarning)),
        ("RuntimeWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::RuntimeWarning)),
        ("StopAsyncIteration", PyObject::exception_type(ferrython_core::error::ExceptionKind::StopAsyncIteration)),
        ("SyntaxWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::SyntaxWarning)),
        ("SystemError", PyObject::exception_type(ferrython_core::error::ExceptionKind::SystemError)),
        ("SystemExit", PyObject::exception_type(ferrython_core::error::ExceptionKind::SystemExit)),
        ("TabError", PyObject::exception_type(ferrython_core::error::ExceptionKind::TabError)),
        ("TimeoutError", PyObject::exception_type(ferrython_core::error::ExceptionKind::TimeoutError)),
        ("UnboundLocalError", PyObject::exception_type(ferrython_core::error::ExceptionKind::UnboundLocalError)),
        ("UnicodeDecodeError", PyObject::exception_type(ferrython_core::error::ExceptionKind::UnicodeDecodeError)),
        ("UnicodeEncodeError", PyObject::exception_type(ferrython_core::error::ExceptionKind::UnicodeEncodeError)),
        ("UnicodeError", PyObject::exception_type(ferrython_core::error::ExceptionKind::UnicodeError)),
        ("UnicodeTranslateError", PyObject::exception_type(ferrython_core::error::ExceptionKind::UnicodeTranslateError)),
        ("UnicodeWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::UnicodeWarning)),
        ("UserWarning", PyObject::exception_type(ferrython_core::error::ExceptionKind::UserWarning)),
        ("Warning", PyObject::exception_type(ferrython_core::error::ExceptionKind::Warning)),
        // Additional builtins
