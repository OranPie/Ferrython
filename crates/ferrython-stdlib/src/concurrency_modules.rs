                ...
                make_builtin(|args| {
                    ...
                    if let PyObjectPayload::Instance(ref inst_data) = inst.payload {
                        ...
                        attrs.insert(
                            ...
                            PyObject::native_closure("weakref.__call__", move |_args| {
                ...
                make_builtin(|_| {
                    ...
                    if let PyObjectPayload::Instance(ref inst_data) = inst.payload {
                        ...
                        attrs.insert(
                            ...
                            PyObject::native_closure(
                                "WeakValueDictionary.__getitem__",
                                move |args| {
                                    if args.is_empty() {
                                        return Err(PyException::type_error(
                        ...
                        attrs.insert(
                            ...
                            PyObject::native_closure(
                                "WeakValueDictionary.__contains__",
                                move |args| {
                                    if args.is_empty() {
                                        return Err(PyException::type_error(
                ...
                make_builtin(|_| {
                    ...
                    if let PyObjectPayload::Instance(ref inst_data) = inst.payload {
                        ...
                        attrs.insert(
                            CompactString::from("__contains__"),
                            PyObject::native_closure(
                                "WeakKeyDictionary.__contains__",
                                move |args| {
                                    if args.is_empty() {
                                        return Err(PyException::type_error(
                                            "__contains__ requires a key",
