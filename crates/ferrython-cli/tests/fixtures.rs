...
fixture_test!(#[ignore = "pre-existing: parser unrecoverable error"] test_phase17, "test_phase17.py");
...
fixture_test!(#[ignore = "pre-existing: dataclass __field_factory__"] test_phase28, "test_phase28.py");
