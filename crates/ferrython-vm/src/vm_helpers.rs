//! VM utility functions — functional helpers, iteration, generators, sorting, and call hooks.
...
use ferrython_core::object::{
    AsyncGenAction, GeneratorState, IteratorData, PyCell, PyObject, PyObjectMethods,
