...
- Phase 2 misc module mechanical splits have started. Low-coupling `__future__`,
  `readline`, `runpy`, `compileall`, `pstats`, `quopri`, and `stringprep`
  implementations now live under `misc_modules/`.
